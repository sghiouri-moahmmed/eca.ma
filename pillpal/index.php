...
<!DOCTYPE html>
    ...
    <body>
        <section class="clock container">
            <div class="notification">Bonjour  <?php echo  $_SESSION['Nom']." " .$_SESSION['Prenom'] ; ?></span></div>
            <div class="clock__container grid">
                ...
                <a href="ajout.php" target="_blank" class="clock__logo">Créer le planning de prise de médicaments</a>
                <a href="calendar.php" target="_blank" class="clock__logo">Voir le planning de prise de médicaments de la semaine</a>
            </div>
        </section>
